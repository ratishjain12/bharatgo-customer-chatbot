(function () {
  ...
  function main() {
    ...
    var mobileMql = window.matchMedia && window.matchMedia("(max-width: 640px)");
    var tabletMql = window.matchMedia && window.matchMedia("(min-width: 641px) and (max-width: 1024px)");
